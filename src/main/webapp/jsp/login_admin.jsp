    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="form-box register">
                <h2 >Registration</h2>
                <form action="registration_admin.jsp">
                    <div class="input-box">
                        <span class="icon"><ion-icon name="libName"></ion-icon>
                        </span>
                        <input type="text" required name="libName">
                    ...
                    <section class="f">
                        ...
                        <form action="https://httpbin.org/get" method="get" >
                            ...
                            <div class="Pc"><p>Already have an account ?</p><a href="login_admin.jsp" class="login-link">Login</a></div>
                        </form>
                        </section>
                </form>
            </div>
